...
// renderizar primer array de comidas--------------------------------
function renderizarIndiceDeComidas(cartaCompleta){
    const sectionIndiceComida = document.getElementById(cartaCompleta);
    sectionIndiceComida.innerHTML = " ";

    for(const listaComidas of cartaCompleta){

        const sectionFlex = document.createElement("section");
        sectionFlex.className = "selection_lista_comidas";
    }
